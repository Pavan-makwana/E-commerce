...
const GlobalAnalytics = () => {
  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50 min-h-screen">
      <h2 className="text-2xl md:text-3xl font-extrabold mb-8 text-gray-800">Platform Analytics</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100">
          <div className="flex justify-between items-center mb-10">
            ...
            <select className="border border-gray-300 rounded px-2 py-1 text-sm text-gray-600 bg-gray-50 outline-none">
          ...
          <div className="flex items-end justify-around h-64 border-b border-gray-200 pb-2 relative">
            ...
            {categoryData.map((item) => (
              <div key={item.label} className="flex flex-col items-center group w-1/5 z-10">
                ...
                ></div>
                <p className="mt-3 font-semibold text-gray-600 text-xs md:text-sm truncate w-full text-center">{item.label}</p>
                <p className="text-[10px] md:text-xs text-gray-400 font-mono">₹{(item.value / 1000).toFixed(1)}k</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Quick Stats Summary */}
        <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col justify-center">
            <h3 className="text-xl font-bold text-gray-700 mb-6">Performance Highlights</h3>
            
            <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-100">
                    <div>
                        <p className="text-green-600 font-bold text-xs md:text-sm uppercase">Top Selling Category</p>
                        <p className="text-xl md:text-2xl font-extrabold text-gray-800">Electronics</p>
                    </div>
                    <Laptop className="w-8 h-8 md:w-10 md:h-10 text-green-200" />
                </div>

                <div className="flex items-center justify-between p-4 bg-orange-50 rounded-lg border border-orange-100">
                    <div>
                        <p className="text-orange-600 font-bold text-xs md:text-sm uppercase">Pending Returns</p>
                        <p className="text-xl md:text-2xl font-extrabold text-gray-800">12 Requests</p>
                    </div>
                ...
                <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-100">
                    <div>
                        <p className="text-blue-600 font-bold text-xs md:text-sm uppercase">New Users (This Week)</p>
                        <p className="text-xl md:text-2xl font-extrabold text-gray-800">+124</p>
                    </div>
